...
mcp = FastMCP("myaccounts_server")

@mcp.tool()
async def get_balance(name: str) -> float:
    """Get the cash balance of a given account name
    Args:
...
async def sell_shares(name: str, symbol: str, quantity: int, rationale: str) -> float:
    ...
    Args:
        ...
        rationale (str): The rationale for the sale and fit with the account's strategy
    """
...
async def change_strategy(name: str, strategy: str) -> str:
    ...
    Args:
        name (str): The name of the account holder
        strategy (str): The new strategy for the account
    """
...
async def read_strategy(name: str) -> str:
    account = Account.get(name.lower())
